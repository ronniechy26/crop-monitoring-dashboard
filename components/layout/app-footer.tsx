...
export function AppFooter({ className }: { className?: string }) {
  ...
  return (
    <footer
      className={cn(
        "relative isolate w-full overflow-hidden border-t border-border/60 bg-background/90 py-10 text-sm text-muted-foreground shadow-[0_-20px_45px_-35px_rgba(15,23,42,0.65)] backdrop-blur supports-[backdrop-filter]:bg-background/75",
        "before:absolute before:-right-20 before:-top-24 before:h-72 before:w-72 before:rounded-full before:opacity-50",
        "after:absolute after:-bottom-24 after:-left-16 after:h-64 after:w-64 after:rounded-full after:opacity-40",
        className,
      )}
    >
      <div className="mx-auto flex w-full max-w-[1920px] flex-col gap-10 px-4 text-sm sm:px-10 lg:px-12">
